...
from jitcsim.models.montbrio_sde import Montbrio_BW
...
if __name__ == "__main__":
    ...
    initial_state = ([rand(), rand()] + [0] * 4) * N
    
    parameters = {
        "N" : N,
        't_initial': 0.,                    # initial time of integration
        "t_final": 400.0,                     # final time of integration
    ...
    ax[0].set_ylabel("r")
    ax[1].set_ylabel("v")
    ax[2].set_ylabel("fmri")

    plt.savefig("data/01_montbrioBW_sde_n.png", dpi=150)
    plt.show()
